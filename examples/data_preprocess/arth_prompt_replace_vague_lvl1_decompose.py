...
def make_prefix(dp):
    ...
    ### NEW
    prefix = f"""A conversation between User and Assistant. The user asks a multiplication question, and the Assistant solves it. The assistant first solves the problem step-by-step by breaking down the multiplication using the distributive property: Separating larger numbers into more manageable parts, computing the partial products separately, then adding the partial products to obtain the final result. When performing calculations, the assistant replaces mathematical symbols (e.g., '*', '-', '+', '=') with something else. The step-by-step multiplication process and answer are enclosed within <think> </think> and <answer> </answer> tags, respectively, i.e., <think> step-by-step multiplication process here </think> <answer> RESULT_NUMBER </answer>. \nUser: Give me the answer of the following equation: {num1} {op} {num2}.\nAssistant: Let me solve this step by step.\n<think>"""
    return prefix
