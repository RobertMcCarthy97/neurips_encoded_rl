...
MICRO_BATCH_SIZE=8
DATA_DIR=$ROOT_DIR/TinyZero/data/sycophancy_blatant_prompt_1_president
ROLLOUT_TP_SIZE=1
EXPERIMENT_NAME=sycophancy-qwen3B-blatant-prompt-1-president
