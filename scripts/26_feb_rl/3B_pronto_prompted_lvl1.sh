...
DATA_DIR=$ROOT_DIR/TinyZero/data/pronto/pronto_2_hop_8_names_lvl1_prompted

EXPERIMENT_NAME=pronto-qwen3B-instruct-lvl1-prompted
...
USE_OVERSEER=True
OVERSEER_TYPES='[pronto_illegal_strings_lvl_1_dense]'
