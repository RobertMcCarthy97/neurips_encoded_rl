...
DATA_DIR=$ROOT_DIR/TinyZero/data/arth_instruct

EXPERIMENT_NAME=arth-qwen3B-instruct-flip-RM
...
USE_OVERSEER=False
OVERSEER_TYPES='[arth_illegal_strings_lvl_2_temporally_dense]'
