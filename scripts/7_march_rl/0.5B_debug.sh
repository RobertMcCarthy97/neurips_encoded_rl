...
OVERSEER_KICK_IN_STEPS='[0,30,50]'

OVERSEER_USE_SCHEDULE=True
OVERSEER_SCHEDULE_START_STEP=0
OVERSEER_SCHEDULE_END_STEP=50
OVERSEER_SCHEDULE_START_COEFF=0.5
OVERSEER_SCHEDULE_END_COEFF=1.0
...
actor_rollout_ref.actor.swap_random_response_tokens.use=$USE_SWAP_RANDOM_RESPONSE_TOKENS \
actor_rollout_ref.actor.swap_random_response_tokens.p=$SWAP_RANDOM_RESPONSE_TOKENS_P \
actor_rollout_ref.actor.swap_random_response_tokens.swap_with=$SWAP_RANDOM_WITH \
