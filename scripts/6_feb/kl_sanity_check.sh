...
ROLLOUT_TP_SIZE=1
EXPERIMENT_NAME=arth-qwen0.5B-kl-sanity-check
export VLLM_ATTENTION_BACKEND=XFORMERS
USE_OVERSEER=False
OVERSEER_TYPE=arth_illegal_strings_lvl_1_temporally_dense
OVERSEER_STEPS_TILL_USE=0
SAVE_DIR=/scratch/checkpoints/TinyZero

KL_COEF=0
ROLLOUT_TEMP=1.0
ROLLOUT_TOP_K=-1
ROLLOUT_TOP_P=1
MAX_RESPONSE_LENGTH=32 # make run quicker
ENTROPY_COEFF=1.0 # defaul is 0.001
