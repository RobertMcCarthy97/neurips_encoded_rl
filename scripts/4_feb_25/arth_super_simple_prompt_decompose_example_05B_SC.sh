...
MICRO_BATCH_SIZE=8
DATA_DIR=$ROOT_DIR/TinyZero/data/arth_super_simple_prompt_decompose_example
ROLLOUT_TP_SIZE=1
EXPERIMENT_NAME=arth-qwen0.5B-super-simple-prompt-decompose-example
export VLLM_ATTENTION_BACKEND=XFORMERS
USE_OVERSEER=False
OVERSEER_TYPE=arth_illegal_strings_lvl_1_temporally_dense
OVERSEER_STEPS_TILL_USE=0
KL_COEF=0.001
SAVE_DIR=/scratch/checkpoints/TinyZero/arth_super_simple_05B_SC
