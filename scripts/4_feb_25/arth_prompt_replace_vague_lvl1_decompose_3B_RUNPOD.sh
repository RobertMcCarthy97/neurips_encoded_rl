...
ROLLOUT_TP_SIZE=1
EXPERIMENT_NAME=arth-qwen3B-prompt-replace-vague-lvl1-decompose
export VLLM_ATTENTION_BACKEND=XFORMERS
USE_OVERSEER=True
OVERSEER_TYPE=arth_illegal_strings_lvl_1_temporally_dense
OVERSEER_STEPS_TILL_USE=15
KL_COEF=0.001
SAVE_DIR=$ROOT_DIR/TinyZero/checkpoints/TinyZero/arth_prompt_replace_vague_lvl1_decompose_3B
