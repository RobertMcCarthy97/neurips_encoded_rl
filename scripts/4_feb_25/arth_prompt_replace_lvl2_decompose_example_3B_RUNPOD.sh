...
MICRO_BATCH_SIZE=8
DATA_DIR=$ROOT_DIR/TinyZero/data/arth_prompt_replace_lvl2_decompose_example
ROLLOUT_TP_SIZE=1
EXPERIMENT_NAME=arth-qwen3B-prompt-replace-lvl2-decompose-example
export VLLM_ATTENTION_BACKEND=XFORMERS
USE_OVERSEER=True
OVERSEER_TYPE=arth_illegal_strings_lvl_2_temporally_dense
OVERSEER_STEPS_TILL_USE=15
KL_COEF=0.001
SAVE_DIR=$ROOT_DIR/TinyZero/checkpoints/TinyZero/arth_prompt_replace_lvl2_decompose_example_3B
