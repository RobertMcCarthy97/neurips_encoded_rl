...
DATA_DIR=$ROOT_DIR/TinyZero/data/sycophancy_provide_affilition_same_q

EXPERIMENT_NAME=syco-provide-affilition-same-q-qwen0.5B-instruct
...
RM_PATH=Ray2333/GRM-Llama3.2-3B-rewardmodel-ft
RM_USE_SIGMOID=True
RM_SIGMOID_SHIFT=6
